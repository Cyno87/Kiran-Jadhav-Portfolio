    ...
    <section className="bg-gradient-to-br from-gray-900 to-slate-700 overflow-hidden" id='projects'>
      <div className="max-w-screen-xl 2xl:max-w-screen-3xl px-8 md:px-12 mx-auto py-12 lg:py-24 space-y-24 h-svh flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <a
            href="#_"
            onClick={() => handleImageClick('Project 1', 'https://github.com/Cyno87/recipe-finder')}
          ...
          <a
            href="#_"
            onClick={() => handleImageClick('Project 2', 'https://github.com/Cyno87/obys-agency-clone/')}
            className="relative overflow-hidden rounded-xl"
          >
            <img
              src={img2}
          ...
          <a
            href="#_"
            onClick={() => handleImageClick('Project 3', 'https://github.com/Cyno87/react-movie-app')}
            className="relative overflow-hidden rounded-xl"
          >
            <img
              src={img3}
